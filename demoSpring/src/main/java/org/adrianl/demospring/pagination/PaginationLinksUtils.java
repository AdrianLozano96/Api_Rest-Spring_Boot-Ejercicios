package org.adrianl.demospring.pagination;
...
@Component
public class PaginationLinksUtils { //Para crear la cabecera links

    public String createLinkHeader(Page<?> page, UriComponentsBuilder uriBuilder) {
        final StringBuilder linkHeader = new StringBuilder();
        linkHeader.append("");

        if (page.hasNext()) {   //Si la página tiene sigiente página se construlle la uri para la siguiente página
    ...
    //Sobre la uri definida sustituir la pagina por la nueva, etc
